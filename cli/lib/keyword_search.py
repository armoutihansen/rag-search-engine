...
class InvertedIndex:
    ...
    def build(self, movies):
        for movie in movies:
            ...
            self.__add_document(
                doc_id, f"{movie['title']} {movie.get('description', '')}"
            )
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise FileNotFoundError(
                "Index files not found. Please run the 'build' command to create the index before loading."
            )
    ...
    def bm25_idf_command(self, term: str) -> float:
        ...
        try:
            ...
            print(
                "Index files not found. Please run the 'build' command to create the index before searching."
            )
            raise FileNotFoundError(
                "Index files not found. Please run the 'build' command to create the index before loading."
            )
