...
def main() -> None:
    ...
    verify_parser.add_argument("image_path", type=str, help="Path to the image to verify embedding generation")
    
    image_search_parser = subparsers.add_parser(
        "image_search",
        help="Search for similar images using an input image query"
    )
    image_search_parser.add_argument("image_path", type=str, help="Path to the image to use as a search query")
